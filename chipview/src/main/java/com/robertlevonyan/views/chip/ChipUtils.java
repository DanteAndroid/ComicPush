...
import com.danteandroid.demo.R;
...
public class ChipUtils {
    ...
    public static void resetAllAndSelectChip(View view, boolean selected) {
        if (view == null || !(view instanceof Chip)) return;
        ...
        ((Chip) view).setSelected(selected);
    }
